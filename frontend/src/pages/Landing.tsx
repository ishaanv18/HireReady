...
export default function Landing() {
    ...
    const features = [
        {
            ...
            description: 'Get instant ATS compatibility scores and personalized recommendations to optimize your resume.',
            path: '/resume',
        ...
        },
        {
            ...
            description: 'Practice with adaptive AI that adjusts difficulty and provides real-time feedback.',
            path: '/interview',
    ...
    const stats = [
        ...
        { icon: Users, label: 'Users Hired', value: '10K+' },
    ...
    return (
        <div ref={containerRef} className="relative min-h-screen w-full overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center">
                <div className="mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 py-36 sm:gap-8 sm:py-44 md:px-10 lg:px-16">
                    <div ref={badgeRef} className="inline-flex items-center gap-2 rounded-full border border-purple-300/20 bg-purple-500/10 px-3 py-1.5 backdrop-blur-sm">
                        <span className="text-[10px] font-light uppercase tracking-[0.08em] text-purple-200">New</span>
                        <span className="h-1 w-1 rounded-full bg-purple-300/60" />
                        <span className="text-xs font-light tracking-tight text-purple-100">AI-Powered Interview Prep</span>
                    </div>
                    ...
                    <p ref={paraRef} className="max-w-xl text-left text-base font-light leading-relaxed tracking-tight text-purple-100/90 sm:text-lg">
                        Your intelligent AI companion for interview preparation and career success. Harness the power of artificial intelligence to ace your next interview.
                    </p>

                    <div className="flex flex-wrap items-center gap-3 pt-2">
                        <SignedOut>
                            <SignUpButton mode="modal">
                                <button className="rounded-2xl border border-purple-300/20 px-5 py-3 text-sm font-light tracking-tight bg-purple-500/20 text-white backdrop-blur-sm hover:bg-purple-500/30 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400/50 duration-300">
                                    Get Started Free
                                </button>
                            </SignUpButton>
                        </SignedOut>
                        <SignedIn>
                            <button
                                ...
                                className="rounded-2xl border border-purple-300/20 px-5 py-3 text-sm font-light tracking-tight bg-purple-500/20 text-white backdrop-blur-sm hover:bg-purple-500/30 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400/50 duration-300"
                            >
                                Go to Dashboard
                            </button>
                        </SignedIn>
                        <a
                            ...
                            className="rounded-2xl border border-purple-300/20 px-5 py-3 text-sm font-light tracking-tight text-purple-100/90 hover:bg-purple-500/10 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400/50 duration-300"
                        >
                            View Features
                        </a>
                    </div>

                    <ul className="mt-8 flex flex-wrap gap-6 text-xs font-extralight tracking-tight text-purple-200/70">
                        <li className="flex items-center gap-2">
                            <span className="h-1 w-1 rounded-full bg-purple-300/60" /> AI Interview Practice
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="h-1 w-1 rounded-full bg-purple-300/60" /> Resume Analysis
                        </li>
                        <li className="flex items-center gap-2">
                            <span className="h-1 w-1 rounded-full bg-purple-300/60" /> Real-time Feedback
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <div id="features" className="relative">
                <div className="max-w-7xl mx-auto px-6 py-12 md:px-10 lg:px-16">
                    {/* Stats */}
                    <motion.div
                    ...
                    >
                        {stats.map((stat, index) => (
                            <div key={index} className="flex items-center space-x-3 bg-white/5 backdrop-blur-sm rounded-xl px-6 py-4 border border-white/10">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                            About <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">HireReady</span>
                        </h2>
                        <p className="text-lg text-purple-100/80 max-w-4xl mx-auto leading-relaxed mb-8">
                            HireReady is an advanced AI-powered platform designed to revolutionize interview preparation.
                            Combining cutting-edge artificial intelligence with comprehensive analytics, we provide
                            personalized feedback, realistic interview simulations, and ATS-optimized resume analysis
                            to help you land your dream job.
                        </p>
                        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                                <div className="text-3xl font-bold text-purple-300 mb-2">AI-Powered</div>
                                <p className="text-sm text-purple-100/70">Leveraging Google Gemini & Groq for intelligent analysis</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                                <div className="text-3xl font-bold text-purple-300 mb-2">Real-time</div>
                                <p className="text-sm text-purple-100/70">Instant feedback and performance metrics</p>
                            </div>
                            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                                <div className="text-3xl font-bold text-purple-300 mb-2">Comprehensive</div>
                                <p className="text-sm text-purple-100/70">End-to-end interview preparation solution</p>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { name: 'React 18', desc: 'Modern UI library with TypeScript' },
                                        { name: 'Tailwind CSS', desc: 'Utility-first styling framework' },
                                        { name: 'Framer Motion', desc: 'Smooth animations & transitions' },
                                        { name: 'React Three Fiber', desc: '3D graphics & visualizations' },
                                        { name: 'React Router', desc: 'Client-side routing' },
                                        { name: 'Clerk', desc: 'Secure authentication' }
                                    ].map((tech, idx) => (
                                        <div key={idx} className="flex items-start space-x-3 bg-white/5 rounded-lg p-3">
                                            <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <div className="font-semibold text-white">{tech.name}</div>
                                                <div className="text-sm text-purple-100/60">{tech.desc}</div>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            {/* Backend Stack */}
                            <div className="bg-gradient-to-br from-green-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        { name: 'MongoDB', desc: 'NoSQL database for flexibility' },
                                        { name: 'Google Gemini AI', desc: 'Advanced language model' },
                                        { name: 'Groq API', desc: 'Fast AI inference' },
                                        { name: 'Apache PDFBox', desc: 'PDF text extraction' },
                                        { name: 'Tesseract OCR', desc: 'Image text recognition' }
                                    ].map((tech, idx) => (
                                        <div key={idx} className="flex items-start space-x-3 bg-white/5 rounded-lg p-3">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
                            System <span className="bg-gradient-to-r from-orange-400 to-purple-400 bg-clip-text text-transparent">Architecture</span>
                        </h2>

                        <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                            <div className="grid md:grid-cols-3 gap-6 mb-8">
                                <div className="text-center">
                                    <div className="w-16 h-16 bg-blue-500/20 rounded-xl flex items-center justify-center mx-auto mb-4">
                                        <FileText className="w-8 h-8 text-blue-400" />
                                    </div>
                                    <h4 className="font-bold text-white mb-2">Frontend Layer</h4>
                                    <p className="text-sm text-purple-100/70">React SPA with responsive design and real-time updates</p>
                                </div>
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-purple-100/70">RESTful APIs with Spring Boot for scalable services</p>
                                </div>
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-purple-100/70">Gemini & Groq integration for intelligent analysis</p>
                                </div>
                            </div>
                            ...
                            return (
                                ...
                                >
                                    <Link to={feature.path}>
                                        <div className="h-full p-8 group cursor-pointer overflow-hidden relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                                            ...
                                            <div className="relative z-10">
                                                <div className="flex items-start justify-between mb-6">
                                                    ...
                                                    <div className="text-xs font-medium text-purple-300 bg-purple-500/20 px-3 py-1 rounded-full">
                                                        {feature.stats}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex items-center text-purple-300 font-medium group-hover:text-purple-200 transition-colors duration-300">
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                { title: 'ATS-Optimized Resumes', desc: 'Ensure your resume passes Applicant Tracking Systems' },
                                { title: 'Real Interview Practice', desc: 'Practice with AI that mimics real interviewers' },
                                { title: 'Detailed Feedback', desc: 'Get actionable insights to improve your performance' },
                                { title: 'Progress Tracking', desc: 'Monitor your improvement with comprehensive analytics' },
                                { title: 'Multiple Interview Types', desc: 'Practice for technical, HR, and behavioral interviews' },
                                { title: 'Confidence Building', desc: 'Build confidence through repeated practice sessions' }
                            ].map((benefit, idx) => (
                                <motion.div
                                    key={idx}
                                    initial={{ opacity: 0, y: 20 }}
                                ...
                                >
                                    <div className="flex items-start space-x-3 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 hover:bg-white/10 transition-all duration-200">
                                        <CheckCircle className="w-6 h-6 text-purple-300 flex-shrink-0 mt-1" />
                                        <div>
                                            <h4 className="font-semibold text-white mb-1">{benefit.title}</h4>
                                            <p className="text-sm text-purple-100/70">{benefit.desc}</p>
                                        </div>
                                    </div>
                                </motion.div>
                            ))}
                    ...
                    >
                        <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-white/10 rounded-3xl p-12 text-center">
                            <h2 className="text-3xl font-bold mb-4 text-white">
                                Ready to boost your interview success?
                            </h2>
                            <p className="text-purple-100/80 mb-8 text-lg max-w-2xl mx-auto">
                                Join thousands of candidates who are already leveraging AI to land their dream jobs.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <SignedOut>
                                    <SignUpButton mode="modal">
                                        <button className="px-8 py-4 bg-white text-purple-700 rounded-xl font-semibold hover:bg-purple-50 shadow-lg hover:shadow-xl transition-all duration-200">
                                            Start Free Trial
                                        </button>
                                    </SignUpButton>
                                </SignedOut>
                                <SignedIn>
                                    <button
                                        onClick={() => navigate('/dashboard')}
                                        className="px-8 py-4 bg-white text-purple-700 rounded-xl font-semibold hover:bg-purple-50 shadow-lg hover:shadow-xl transition-all duration-200"
                                    >
                                        Go to Dashboard
                                    </button>
                                </SignedIn>
                                <button
                                    ...
                                    className="px-8 py-4 border-2 border-white text-white rounded-xl font-semibold hover:bg-white hover:text-purple-700 transition-all duration-200"
                                >
                                    Analyze Resume
                                </button>
                            </div>
